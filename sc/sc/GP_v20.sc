...
// Original source: /Users/md/Documents/UCL 3/final year project/code/sc/sc/GP_v2.sc
...
//0
main (%d385 NOP(0,0) %d2)
data_center (%d11 NOP(0,0) %d0)
data1 (%d20 NOP(0,0) %d121)
data1 (%d3 NOP(0,0) %d11)
fitness (%d19 NOP(0,0) %d385)
...
bmark ([num zero dontcare] BITMARK_INIT(0,0) [num zero dontcare])
...
tagc ([dontcare dontcare dontcare] TAG_CHAIN(0,0) [dontcare dontcare dontcare])
