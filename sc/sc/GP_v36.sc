...
// and the program begins here:
//0
main0 (%d3025 NOP(0,0) %d2)
main1 (%d130 NOP(0,0) %d5)
[0:1]data_center (%d11 NOP(0,0) %d0)
data0 (%d3 NOP(0,0) %d11)
data0 (%d20 NOP(0,0) %d1331)
fitness0 (%d19 NOP(0,0) %d3025)
fitness1 (%d19 NOP(0,0) %d130)
