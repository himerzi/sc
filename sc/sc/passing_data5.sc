...
// Original source: /Users/md/Documents/UCL 3/final year project/code/sc/sc/passing_data.sc
...
data2 (%d1 NOP(0,0) %d13)
data3 (%d12 NOP(0,0) %d7)
...
capt ([garbage_s1 zero garbage] CAPTURE(0,0) [bin_label zero dontcare])
capt2 ([garbage_s1 zero garbage] CAPTURE(0,0) [bin_label zero dontcare])
