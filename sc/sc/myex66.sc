...
a3 (%d85 NOP(0,0) %d0)
a4 (%d146 NOP(0,0) %d0)
minus ([first zero dontcare] SUBTRACTe(0,0) [second zero dontcare])
times ([first zero dontcare] MULT(0,0) [first zero dontcare])
output ([first dontcare dontcare] PRINT(0,0) [first dontcare dontcare])
[1:2]c (%d255 %d63 %d255)
