...
#label garbage_s1           %b1?000000000000000000000000000000
...
capt ([garbage_s1 zero garbage] CAPTURE(0,0) [bin_label dontcare dontcare])
...
//garbage looks like [x x %d0] and [x x %d1]
}
