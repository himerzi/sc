...
// and the program begins here:
//0
main0 (%d415 NOP(0,0) %d11)
main1 (%d0 NOP(0,0) %d11)
[2:3]main (%d0 NOP(0,0) %d9)
[0:3]data_center (%d11 NOP(0,0) %d0)
data0 (%d3 NOP(0,0) %d11)
data1 (%d20 NOP(0,0) %d124)
fitness (%d19 NOP(0,0) %d415)
...
[0:3]data_mark ([dontcare zero dontcare] BITMARKP1(0,0) [three zero dontcare])
