...
// and the program begins here:
//0
main0 (%d55 NOP(0,0) %d2)
main1 (%d0 NOP(0,0) %d5)
[0:1]data_center (%d11 NOP(0,0) %d0)
data0 (%d20 NOP(0,0) %d11)
data0 (%d3 NOP(0,0) %d11)
[0:1]fitness (%d19 NOP(0,0) %d55)
...
[0:1]hollow ([three zero dontcare] NOP(0,0) [three zero dontcare])
[10:11]hollow ([three zero dontcare] NOP(0,0) [three zero dontcare])
data1 (%d20 NOP(0,0) %d11)
