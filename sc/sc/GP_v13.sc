...
// Original source: /Users/md/Documents/UCL 3/final year project/code/sc/sc/GP_v1.sc
...
hollow ([three zero dontcare] MULT_V2(0,0) [three zero dontcare])
...
#chain bmark
{
($L hollow $R) + ($L capt_ans ?A) + ($R capt A)
}
