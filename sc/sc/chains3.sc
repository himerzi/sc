...
main (%d0 NOP(0,0) %d0)
a1 (%d12 NOP(0,0) %d65526)
a2 (%d11 NOP(0,0) %d0)
a3 (%d1 NOP(0,0) %d4)
a4 (%d2 NOP(0,0) %d0)
minus ([twelve zero dontcare] SUBTRACTe(0,0) [dontcare zero dontcare])
times ([twelve zero dontcare] MULT(0,0) [dontcare zero dontcare])
output ([twelve zero dontcare] PRINT(0,0) [dontcare zero dontcare])
