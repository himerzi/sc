...
data0 (%d1 NOP(0,0) %d5)
data1 (%d21 NOP(0,0) %d12)
data10 (%d1 NOP(0,0) %d5)
data11 (%d4 NOP(0,0) %d4)
fitness0 (%d19 NOP(0,0) %d22)
fitness1 (%d19 NOP(0,0) %d30)
...
[0:1]output ([dontcare zero dontcare] PRINT(0,0) [four zero dontcare])
[0:1]tst_output ([dontcare zero dontcare] PRINT(0,0) [dontcare zero dontcare])
...
[0:1]mark_ans ([three zero dontcare] (0,0) [dontcare dontcare dontcare])
universe (%d0 NOP(0,0) %d0)
hollow0 ([three zero dontcare] ADD3(0,0) [three zero dontcare])
hollow1 ([three zero dontcare] ADD1(0,0) [three zero dontcare])
