...
resetter ([dontcare zero dontcare] BITMARKP1(0,0) [three zero dontcare])
recorder ([dontcare dontcare dontcare] BITMARKP1(0,0) [three zero dontcare])
output ([dontcare dontcare dontcare] BITMARKP1(0,0) [three zero dontcare])
dmark (%d0 NOP(0,0) %d0)
...
#chain dmark
{
($L output $R) + ($L recorder ?A) + ($L resetter $R) 
}
