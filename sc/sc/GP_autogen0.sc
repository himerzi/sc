...
// and the program begins here:
//0
main0 (%d105 NOP(0,0) %d2)
main1 (%d0 NOP(0,0) %d0)
[0:1]data_center (%d11 NOP(0,0) %d0)
data0 (%d3 NOP(0,0) %d11)
data1 (%d1 NOP(0,0) %d1)
data10 (%d20 NOP(0,0) %d16)
data11 (%d1 NOP(0,0) %d1)
fitness0 (%d19 NOP(0,0) %d105)
fitness1 (%d19 NOP(0,0) %d0)
...
hollow11 ([three zero dontcare] NOP(0,0) [three zero dontcare])
