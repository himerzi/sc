...
data5 (%d1 NOP(0,0) %d9)
data6 (%d1 NOP(0,0) %d10)
data7 (%d1 NOP(0,0) %d11)
data8 (%d3 NOP(0,0) %d11)
data9 (%d1 NOP(0,0) %d9)
data10 (%d20 NOP(0,0) %d12)
data11 (%d20 NOP(0,0) %d67)
data12 (%d20 NOP(0,0) %d13)
data13 (%d1 NOP(0,0) %d8)
data14 (%d20 NOP(0,0) %d23)
data15 (%d1 NOP(0,0) %d9)
data16 (%d1 NOP(0,0) %d10)
data17 (%d1 NOP(0,0) %d11)
data18 (%d20 NOP(0,0) %d122)
data19 (%d1 NOP(0,0) %d9)
fitness0 (%d19 NOP(0,0) %d63)
fitness1 (%d19 NOP(0,0) %d161)
fitness2 (%d19 NOP(0,0) %d68)
fitness3 (%d19 NOP(0,0) %d70)
fitness4 (%d19 NOP(0,0) %d120)
fitness5 (%d19 NOP(0,0) %d60)
fitness6 (%d19 NOP(0,0) %d108)
fitness7 (%d19 NOP(0,0) %d440)
...
hollow6 ([three zero dontcare] ADD1(0,0) [three zero dontcare])
[7:8]hollow ([three zero dontcare] MULT_V2(0,0) [three zero dontcare])
hollow9 ([three zero dontcare] MARK_ANSWER(0,0) [three zero dontcare])
hollow10 ([three zero dontcare] ADD2(0,0) [three zero dontcare])
[11:13]hollow ([three zero dontcare] MARK_ANSWER(0,0) [three zero dontcare])
[14:15]hollow ([three zero dontcare] ADD2(0,0) [three zero dontcare])
