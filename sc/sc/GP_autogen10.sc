...
// and the program begins here:
//0
main0 (%d440 NOP(0,0) %d2)
main1 (%d95 NOP(0,0) %d5)
main2 (%d0 NOP(0,0) %d8)
main3 (%d105 NOP(0,0) %d11)
main4 (%d85 NOP(0,0) %d14)
main5 (%d105 NOP(0,0) %d17)
main6 (%d85 NOP(0,0) %d20)
main7 (%d75 NOP(0,0) %d23)
main8 (%d120 NOP(0,0) %d26)
main9 (%d130 NOP(0,0) %d29)
[0:9]data_center (%d11 NOP(0,0) %d0)
[0:1]data (%d3 NOP(0,0) %d11)
data2 (%d1 NOP(0,0) %d11)
data3 (%d20 NOP(0,0) %d16)
data4 (%d3 NOP(0,0) %d11)
data5 (%d20 NOP(0,0) %d16)
[6:9]data (%d3 NOP(0,0) %d11)
data10 (%d20 NOP(0,0) %d132)
data11 (%d20 NOP(0,0) %d15)
data12 (%d1 NOP(0,0) %d11)
data13 (%d3 NOP(0,0) %d11)
data14 (%d20 NOP(0,0) %d14)
data15 (%d3 NOP(0,0) %d11)
data16 (%d20 NOP(0,0) %d14)
data17 (%d20 NOP(0,0) %d13)
data18 (%d20 NOP(0,0) %d23)
data19 (%d20 NOP(0,0) %d24)
fitness0 (%d19 NOP(0,0) %d440)
fitness1 (%d19 NOP(0,0) %d95)
fitness2 (%d19 NOP(0,0) %d115)
fitness3 (%d19 NOP(0,0) %d105)
fitness4 (%d19 NOP(0,0) %d85)
fitness5 (%d19 NOP(0,0) %d105)
fitness6 (%d19 NOP(0,0) %d85)
fitness7 (%d19 NOP(0,0) %d75)
fitness8 (%d19 NOP(0,0) %d120)
fitness9 (%d19 NOP(0,0) %d130)
...
[4:5]hollow ([three zero dontcare] ADD3(0,0) [three zero dontcare])
[6:7]hollow ([three zero dontcare] ADD2(0,0) [three zero dontcare])
hollow8 ([three zero dontcare] ADD1(0,0) [three zero dontcare])
...
hollow12 ([three zero dontcare] MARK_ANSWER(0,0) [three zero dontcare])
...
[17:18]hollow ([three zero dontcare] ADD2(0,0) [three zero dontcare])
hollow19 ([three zero dontcare] ADD1(0,0) [three zero dontcare])
