...
esc ([num zero dontcare] ESCAPE(0,0) [num zero dontcare])
times ([three zero dontcare] MULT_V2(0,0) [three zero dontcare])
incrementor ([num zero dontcare] INCREMENTOR(0,0) [num zero dontcare])
recorder ([dontcare zero dontcare] RECORDER(0,0) [dontcare zero dontcare])
resetter ([dontcare zero dontcare] RESETTER(0,0) [three zero dontcare])
output ([dontcare zero dontcare] PRINT(0,0) [three zero dontcare])
