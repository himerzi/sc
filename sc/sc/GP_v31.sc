...
data0 (%d20 NOP(0,0) %d15)
[0:1]fitness (%d19 NOP(0,0) %d95)
...
[0:1]hollow ([three zero dontcare] ADD3(0,0) [three zero dontcare])
[10:11]hollow ([three zero dontcare] ADD3(0,0) [three zero dontcare])
